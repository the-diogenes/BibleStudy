// Runtime config for the Bible Study app.
// The Supabase publishable/anon key is designed to be public; your data is
// protected by Row-Level Security (supabase/schema.sql). Safe to commit.
