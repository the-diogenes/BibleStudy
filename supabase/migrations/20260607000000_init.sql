-- Bible Study - initial schema (mirrors supabase/schema.sql).
-- Apply via either:
--   * Supabase SQL Editor: paste supabase/schema.sql, OR
--   * CLI: supabase link --project-ref dlutohlrkahycvmdhskp && supabase db push
